   ...
   <div class="internal-page-section">
    <div class="container">
        <div class="internal-page-content">
            ...
            <p>The ShowSearch app is free to the manufactures of factory-built homes and retailers wanting to identify production facilities which can efficiently supply homes to the retailer location.</p>
        </div>
    </div>
    </div>
</body>
